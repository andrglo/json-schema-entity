const jsonSchemaTable = require('../src/json-schema-table')
const _ = require('lodash')
const utils = require('../src/json-schema-table-utils')

const personSchema = require('./schemas/json-schema-table/person.json')
const clientSchema = require('./schemas/json-schema-table/client.json')
const façadeSchema = require('./schemas/json-schema-table/façade.json')
const personFaçadeSchema = require('./schemas/json-schema-table/personFaçade.json')
const taxSchema = require('./schemas/json-schema-table/tax.json')
const catalogSchema = require('./schemas/json-schema-table/catalog.json')
const reffabSchema = require('./schemas/json-schema-table/reffab.json')
const refforfabSchema = require('./schemas/json-schema-table/refforfab.json')
